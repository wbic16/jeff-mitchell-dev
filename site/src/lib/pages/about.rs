            ...
            <main class="content">
                <section >
                    <article>
                        ...
                        <br />
                        <h3>{ "My Site" }</h3>
                        <p>{ "My site will never have ads, affiliate links, tracking, analytics, paywall or sponsored posts. I want to share what I learn about Rust and hopefully inspire others to pick it up. I'm a fish swimming up river here, because right in this moment the world feels the negative effects of the lack of reliable and efficient software every single day. I hope this site serves as an inspiration that we can and should do better. A secondary goal is to show the world that Rust is a full stack language, capable of making all the things." }</p>
                        <br />
